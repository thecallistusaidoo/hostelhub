      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="kwame@umat.edu.gh or 0244xxxxxx"
                value={email}
            ...
            <Link href="/student/dashboard" className="block w-full text-center btn-primary py-3 text-base">
              Sign In
            </Link>
            ...
            <button className="w-full btn-ghost py-3 flex items-center justify-center gap-2 text-sm">
          ...
          <p className="text-center text-sm text-gray-400 mt-5">
            New to HostelHub?{" "}
            <Link href="/student/signup" className="text-[#1E40AF] font-semibold hover:underline">Create account</Link>
          </p>
          <p className="text-center text-sm text-gray-400 mt-2">
            Are you a host?{" "}
            <Link href="/host/login" className="text-[#F59E0B] font-semibold hover:underline">Host login →</Link>
          </p>
        </div>
      </div>
    </div>
