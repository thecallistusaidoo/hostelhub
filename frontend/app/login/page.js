...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white border-b border-gray-100 px-4 h-14 flex items-center gap-3">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <p className="text-gray-400 text-sm mb-6">Sign in — works for students, hosts and admins.</p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-white"
              ...
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <Link href="/forgot-password" className="text-xs text-[#1E40AF] font-semibold hover:underline">Forgot password?</Link>
                </div>
                <input className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-white"
              ...
              <button className="w-full border border-gray-200 hover:border-gray-300 bg-white text-gray-700 text-sm font-medium rounded-xl py-3 flex items-center justify-center gap-2 transition">
            ...
            <p className="text-center text-sm text-gray-400 mt-5">
              ...
              <Link href="/signup" className="text-[#1E40AF] font-semibold hover:underline">Sign up free</Link>
            </p>
          </div>
        </div>
      </div>
